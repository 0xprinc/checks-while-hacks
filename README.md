...
- [x] [`MixBytes` DAO voting vulnerabilities](https://mixbytes.io/blog/dao-voting-vulnerabilities)
...
- [x] [@zobront obol protocol](https://github.com/zobront/audits/blob/main/reports/obol.md)
- [x] [@zobront nouns agora](https://github.com/zobront/audits/blob/main/reports/alligator.md)
- [x] [@pashov Pump - ERC20 launch platform](https://github.com/pashov/audits/blob/master/solo/Pump-security-review.md)
- [x] [@paladin Sec Ghast Protocol](https://paladinsec.co/projects/ghast-protocol/)
- [x] [@pashov Lumin - fixed-rate peer-to-peer lending](https://github.com/pashov/audits/blob/master/solo/Lumin-security-review.md)
...
11. What if the two arguments provided to be same, i.e. sender == receiver, source =  destination etc.
